...
\begin{center}
    ...
    \caption{Verstärkung des A8331 gemittelt über einen 50 MHz Sweep. Ist und Soll gegenübergestellt. Zudem die Differenz zu jedem Wert.}
    \label{fig:T_A8331}
\end{center}
\end{figure}

Bei allen Messungen mit dem zweiten PCB wurde der DAC nicht verbaut. Dies, da wir den verdacht haben, dass dieser viel Rauschen mit sich bringt. Er wurde durch eine externe Spannungsversorgung ersetzt. In weiteren Versuchen soll dieser natürlich noch genau evaluiert werden.
